...
- The symbol $p$ will be aggressively abused and overloaded to represent any probability distribution, sometimes several in the same sentence. So $p(x)$ is the density of the random variable $x$, and $p(y,\,z)$ is the joint density of the random pair $(y,\,z)$, and $p(\boldsymbol{\beta}\,|\,\sigma^2)$ is the conditional density of...you get the idea.
:::
