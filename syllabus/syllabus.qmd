...
+===========================+===============+===============+==============================+
| ![](images/al.jpg){.circ} | Li, Aihua     | TA            | Thu 10:30 AM - 12:30 PM\     |
|                           |               |               | remote (Zoom link on Canvas) |
+---------------------------+---------------+---------------+------------------------------+
| ![](images/jz.jpg){.circ} | Zito, John    | Instructor    | Tue 1:00 PM - 3:00 PM\       |
|                           |               |               | *or by appointment*\         |
|                           |               |               | Old Chem 207                 |
+---------------------------+---------------+---------------+------------------------------+
...
- **Final project**: Due **9AM on Wednesday December 10**. Working *solo or in pairs*, write a 5 - 10 page report that applies or extends ideas from the course. You can write a report that falls into one of these three categories:

    - [`research progress`] some of you are already working on research projects that have a time series component. If you want, you can use your final report as an opportunity to make progress on your research and get feedback from me. You can just execute something you were already planning on doing, but alternatively, I encourage you to use the project as a low-stakes venue within which you can experiment with something new;
    - [`self-study`] there are so many area of time series analysis that we didn't talk about at all: seasonality, deep theory, exponential smoothing, fancy forecast combination methods, frequency-domain analysis, factor modeling, etc. If there is a topic you have heard about that you wish we had covered, use the final report as an opportunity to self-study this topic by reading relevant books and articles, and synthesize your study into a concise set of notes that you can refer to later;
    - [`AI takeover?`] the methods we studied in our class are as old as the hills: ARMA, DLMs, HMMs. These are fundamental tools that form the building blocks of more sophisticated methods. But in this day and age, you also have the option to brainlessly dump your data into an LLM or Meta's Prophet and just sort of vibe. For all I know, that works well enough and everything we did this semester is officially obsolete. I somehow doubt it, but I don't actually know. So go find out! Pick a time series dataset that interests you, construct a traditional state-space model that is appropriate for forecasting these data, and also naively plug the data into some black box AI tool. Use methods from our course to compare the performance of the *probabilistic predictons* from these two methods, and render a verdict: is it time to burn all of the old time series textbooks?
