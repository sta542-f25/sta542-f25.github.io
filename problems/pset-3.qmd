...
The latent state $h_t$ is the *precision* (inverse variance) of $y_t$, and this model captures *heteroskedasticity* in $y_t$. It turns out that this is one of the few state-space models that we can "solve" analytically. Behold:
