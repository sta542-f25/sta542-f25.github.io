---
title: "Problem Set 3"
subtitle: Due Monday November 3 at 11:30 AM
draft: false
editor: 
  mode: source
---
...
Now return to the state-space model. Assume we enter period $t$ with the period $t-1$ filtering distribution 

$$
h_{t-1}\mid y_{1:t-1}
\sim 
\text{Gamma}\left(a_{t-1|t-1}=\alpha+\frac{1}{2},\,b_{t-1|t-1}\right).
$$

Derive a recursion for the state predictive distribution:
...
$$
p(h_{0:T}\mid y_{1:T})=p(h_T\mid y_{1:T})\prod_{t=0}^{T-1}p(h_t\mid h_{t+1},\,y_{1:t}),
$$
