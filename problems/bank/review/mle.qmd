...
d. Implement the bootstrap to simulate the sampling distribution of $\hat{\theta}_n^{(\text{MLE})}$, and compare the simulated distribution to the exact one you derived in the previous part. In order to do this, you will probably need your algorithm from the first part.
