...
::: incremental
- The AR(1) has been *very* well studied;
- OLS "works" no matter the regime;
- If things are non-stationary, stuff gets weird and inference is more challenging, but not impossible;
- The math is...interesting. See Hamilton (1994) Chapter 17 if you're dying of curiosity;
