...
+---------------------------+---------------+---------------+------------------------+
| ![](images/jz.jpg){.circ} | Zito, John    | Instructor    | Tuesday?               |
+---------------------------+---------------+---------------+------------------------+
: {tbl-colwidths="[20,20,25,35]"}

# Time series are everywhere

## Example: unemployment

<iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1L254&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden; width:670px; height:525px;" allowTransparency="true" loading="lazy"></iframe>

## Example: mortgage rates

<iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1LJ4Z&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden; width:670px; height:525px;" allowTransparency="true" loading="lazy"></iframe>

## Example: Case-Shiller home price index

<iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1L3wp&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden; width:670px; height:525px;" allowTransparency="true" loading="lazy"></iframe>

## Example: IMF global energy price index

<iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1LL3k&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden; width:670px; height:525px;" allowTransparency="true" loading="lazy"></iframe>

## Example: EEG

![](images/eeg-data.png){fig-align="center"}

## Example: word mentions

<iframe name="ngram_chart" src="https://books.google.com/ngrams/interactive_chart?content=string,recession,Watergate&year_start=1800&year_end=2022&corpus=en&smoothing=0" width=900 height=500 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no></iframe>


## Example: personal health

![](images/berlind-step-count.png){fig-align="center"}
...
With only 23 lectures, we will go deep on a fairly narrow set of issues in time series analysis. Hopefully you will leave the course with a strong foundation to study *the rest* of time series analysis, should you so choose.
...
1. If you understand how to manipulate the multivariate normal, much of time series analysis is immediately accessible;
:::
...
## Those ugly conditional formulas are not new {.medium .scrollable}
